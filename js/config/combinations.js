...
export const CARD_COMBINATIONS = {
    ...
    'CHAR_investigator+ITEM_corpse_lu': { type: 'explore', result: ["ITEM_crumpled_paper","ITEM_stylus"], message: '初级调查员颤抖着翻开陆珩松的口袋，发现了一张皱巴巴的纸条和一枚沾着暗红的唱针。', delay: 3000 },
    ...
    'CHAR_zs+LOGIC_capture': { type: 'capture', result: ["CLUE_shadow","CLUE_whisper","CLUE_blood"], message: '⚡ 捕获！从朱穗身上提取到隐藏线索！', delay: 3000 },
    'CHAR_investigator+LOGIC_capture': { type: 'capture', result: ["CLUE_cold","CLUE_blood"], message: '⚡ 捕获！从初级调查员身上提取到隐藏线索！', delay: 3000 },
    'ITEM_sdt+LOGIC_capture': { type: 'capture', result: ["CLUE_xhpb"], message: '⚡ 捕获！从手电筒中提取到隐藏线索！', delay: 3000 },
